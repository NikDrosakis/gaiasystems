...
<div class="slideshow-container">
    ...
    //V0
    $slides = $this->db->fa("SELECT * FROM wid_slideshow ORDER BY sort DESC");
    ...
    <div class="mySlides fade">
        ...
        <img src="/media/slideshow/<?=$slides[$i]['filename']?>" style="width:100%">
...
<script src="/cubos/slideshow/slideshow.js"></script>