<?php //updated:2020-01-29 20:20:34 page- v.0.73 - Author:Nikos Drosakis - License: GPL License ?>
<?php define("BUILDEROOT","/admin/lib/builder/");?>
    <link href="<?=BUILDEROOT?>css/editor.css" rel="stylesheet">
    <link href="<?=BUILDEROOT?>css/line-awesome.css" rel="stylesheet">
	<div id="vvveb-builder">
				<div id="top-panel">
					<img src="<?=BUILDEROOT?>img/logo.png" alt="Vvveb" class="float-left" id="logo">
					...
					<div class="btn-group float-left" role="group">
					  <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button" aria-pressed="false">
						  <img src="<?=BUILDEROOT?>libs/builder/icons/file-manager-layout.svg" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
						  <img src="<?=BUILDEROOT?>libs/builder/icons/left-column-layout.svg" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
						  <img src="<?=BUILDEROOT?>libs/builder/icons/right-column-layout.svg" width="20px" height="20px">
					  </button>
					</div>
			...
			<div class="col-sm-9 input">
				<div>    
					<select class="form-control custom-select" name="startTemplateUrl">        
						...
						<option value="<?=BUILDEROOT?>demo/narrow-jumbotron/index.html">Narrow jumbotron</option>
						<option value="<?=BUILDEROOT?>demo/album/index.html">Album</option>
					</select>    
				</div>
			</div>     
		</div>
...
<script src="<?=BUILDEROOT?>js/jquery.hotkeys.js"></script>

<!-- bootstrap-->
<script src="<?=BUILDEROOT?>js/popper.min.js"></script>
<!--<script src="js/bootstrap.min.js"></script>-->

<!-- builder code-->
<script src="<?=BUILDEROOT?>libs/builder/builder.js"></script>
<!-- undo manager-->
<script src="<?=BUILDEROOT?>libs/builder/undo.js"></script>
<!-- inputs-->
<script src="<?=BUILDEROOT?>libs/builder/inputs.js"></script>
...
<!-- components-->
<script src="<?=BUILDEROOT?>libs/builder/components-server.js"></script>
<script src="<?=BUILDEROOT?>libs/builder/components-bootstrap4.js"></script>
<script src="<?=BUILDEROOT?>libs/builder/components-widgets.js"></script>

<!-- blocks-->
<script src="<?=BUILDEROOT?>libs/builder/blocks-bootstrap4.js"></script>

<!-- plugins -->

<!-- code mirror - code editor syntax highlight -->
<link href="<?=BUILDEROOT?>libs/codemirror/lib/codemirror.css" rel="stylesheet"/>
<link href="<?=BUILDEROOT?>libs/codemirror/theme/material.css" rel="stylesheet"/>
<script src="<?=BUILDEROOT?>libs/codemirror/lib/codemirror.js"></script>
<script src="<?=BUILDEROOT?>libs/codemirror/lib/xml.js"></script>
<script src="<?=BUILDEROOT?>libs/codemirror/lib/formatting.js"></script>
<script src="<?=BUILDEROOT?>libs/builder/plugin-codemirror.js"></script>
...
<!--<script src="--><?//=BUILDEROOT?><!--libs/jquery.autocomplete.js"></script>-->
...
$(document).ready(function() 
{
	...
	Vvveb.Builder.init('<?=BUILDEROOT?>demo/narrow-jumbotron/index.html', function() {
	...
	[
        ...
        //if (in_array($file, array('new-page-blank-template.html', 'view.php'))) continue;//skip template files
        //$pathInfo = pathinfo($file);
        ?>
        //{name:"<?php echo ucfirst($pathInfo['filename']);?>", title:"<?php echo ucfirst($pathInfo['filename']);?>",  url: "<?=SITE_URL.'/templates/'.$this->G['template'].'/'.$pathInfo['basename'];?>"},
        {name:"<?=$page?>", title:"<?=ucfirst($page)?>", url: "<?=$this->SITE_URL.$page?>"},
		<?php } ?>		
		{name:"narrow-jumbotron", title:"Jumbotron",  url: "<?=BUILDEROOT?>demo/narrow-jumbotron/index.html", assets: ['<?=BUILDEROOT?>demo/narrow-jumbotron/narrow-jumbotron.css']},
		//{name:"landing-page", title:"Landing page",  url: "<?=BUILDEROOT?>demo/startbootstrap-landing-page/index.html", assets: ['<?=BUILDEROOT?>demo/startbootstrap-landing-page/css/landing-page.min.css']},
		//{name:"album", title:"Album",  url: "<?=BUILDEROOT?>demo/album/index.html", folder:"content", assets: ['<?=BUILDEROOT?>demo/album/album.css']},
		//{name:"blog", title:"Blog",  url: "<?=BUILDEROOT?>demo/blog/index.html", folder:"content", assets: ['<?=BUILDEROOT?>demo/blog/blog.css']},
		//{name:"carousel", title:"Carousel",  url: "<?=BUILDEROOT?>demo/carousel/index.html", folder:"content", assets: ['<?=BUILDEROOT?>demo/carousel/carousel.css']},
		//{name:"offcanvas", title:"Offcanvas",  url: "<?=BUILDEROOT?>demo/offcanvas/index.html", folder:"content", assets: ['<?=BUILDEROOT?>demo/offcanvas/offcanvas.css','<?=BUILDEROOT?>demo/offcanvas/offcanvas.js']},
		//{name:"pricing", title:"Pricing",  url: "<?=BUILDEROOT?>demo/pricing/index.html", folder:"ecommerce", assets: ['<?=BUILDEROOT?>demo/pricing/pricing.css']},
		//{name:"product", title:"Product",  url: "<?=BUILDEROOT?>demo/product/index.html", folder:"ecommerce", assets: ['<?=BUILDEROOT?>demo/product/product.css']},
	]);
