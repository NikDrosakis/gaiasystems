...
define('PUBLIC_ROOT_WEB',GSROOT.''.TEMPLATE.'/');
...
define('UPLOADS_ROOTPATH', GSROOT.'media/');
define('MEDIA_ROOT', GSROOT.'media/');
define('UPLOADS', SITE_URL.'media/');
define('UPLOADS_ICON', SITE_URL.'media/thumbs/');
define('UPLOADS_ROOTPATH_ICON', GSROOT."media/thumbs/");
define('URL_FILE',basename($_SERVER['PHP_SELF']));
define('IMG',"/media/");
define ('TEMPLATESURI',PUBLIC_ROOT_WEB."templates/");

$this->G= array(
    'LIB'=> SITE_URL."/admin/lib/",
    'IMG'=> SITE_URL."img/",
    'TEMPLATE'=>TEMPLATE,
...
//preserver uris array 2nd level SITE_URL/[uri]
    ...
    'WIDGETPATH'=> "/widgets/",
    'WIDGETLOCALURI'=> CUBOS_ROOT,
    'WIDGETURI'=> CUBOS_ROOT,
    'MAINURI'=> PUBLIC_ROOT_WEB."main/",
//*********************MEDIA**********************
    'LOC'=> "en",
    'UPLOADS'=> UPLOADS,
    'UPLOADS_ICON'=> UPLOADS_ICON,
    'UPLOADS_ROOTPATH'=> UPLOADS_ROOTPATH,
    'UPLOADS_ROOTPATH_ICON'=> UPLOADS_ROOTPATH_ICON,
//*********************BACKUPS -STORE *********************
...
$this->G["status_message"] = array(
 ...
 $this->G['icons'] =$this->icons=array(
		...
		$this->G['page']= $_GET['page']!='' ?  $_GET['page'] : ($this->G['CUR_DIR']=='admin' ? 'layout':'books');
		$this->G['sub']=$_GET['sub'] ?? '';
        $this->G['id']=$_GET['id'] ?? '';
        $this->G['mode']=$this->uid = $_GET['uid'] ?? '';
