/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+apacheconf+php+sql&plugins=line-numbers+toolbar+jsonp-highlight+command-line+copy-to-clipboard */
...
(function(){
	...
	Prism.plugins.toolbar.registerButton('copy-to-clipboard', function (env) {
		...
		linkCopy.setAttribute("id", "console-copy");
