  ...
  var dom = (function () {
    ...
    var withClosestSiblings = function (node, pred) {
      ...
      if (node.previousSibling && pred(node.previousSibling)) {
        siblinG.push(node.previousSibling);
      }
      siblinG.push(node);
      if (node.nextSibling && pred(node.nextSibling)) {
        siblinG.push(node.nextSibling);
      }
      return siblings;
    };
  ...
  var range = (function () {
    ...
    var WrappedRange = function (sc, so, ec, eo) {
      ...
      this.wrapBodyInlineWithPara = function () {
        ...
        inlineSiblings = inlineSiblinG.concat(dom.listNext(topAncestor.nextSibling, dom.isParaInline));

        // wrap with paragraph
        if (inlineSiblinG.length) {
