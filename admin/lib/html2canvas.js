...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var rgb = function (args) {
        var tokens = arG.filter(nonFunctionArgSeparator);
        if (tokens.length === 3) {
    ...
    var matrix = function (args) {
        var values = arG.filter(function (arg) { return arg.type === TokenType.NUMBER_TOKEN; }).map(function (arg) { return arg.number; });
