...
function xecho($quer){
    echo '<pre style="position:absolute;right:0;width:400px;overflow:scroll;float: left; word-wrap: break-word;overflow-wrap:break-word; !important;background:black;color:white;padding:10px">';
    print_r($quer);
echo '</pre>';
}
