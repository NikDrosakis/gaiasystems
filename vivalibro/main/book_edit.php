...
$img=$sel['img']==null ? $G['bookdefaultimg']: (strpos($sel['img'], 'http') === 0 ? $sel['img']: "/media/".$sel['img']);
    ?>
<h2 id="titlebig"><?=$sel['title']?><a href="/<?=$G['page']?>?id=<?=$G['id']?>&mode=read">
        <ion-icon class="<?=$G['page']=='login'?'active':''?>"  style="vertical-align: middle;color:#71400c;"  alt="Edit" name="book" size="medium"></ion-icon>
    </a></h2>
